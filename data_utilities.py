...
def CUB2011_loader(root, image_size, display_random=False, normalize=True):
	transformations	= [transforms.Scale(image_size), transforms.ToTensor()]
	if normalize == True:
		transformations.append(transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)))
	cub2011_data	= CUB2011(root=root, download=True, transform=transforms.Compose(transformations))
	return cub2011_data